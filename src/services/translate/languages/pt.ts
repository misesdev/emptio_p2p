...
export default {
    ...
    "wallet.create.label": "Criar uma carteira nova de 12 palavras bip39 com ou sem passphrase",
    "wallet.import.label": "Importar uma carteira a partir da 12 palavras bip39 com ou sem passphrase",
    "wallet.name.title": "Dê um nome para sua carteira",
    "wallet.name.description": "Escolha um nome para identificar esta carteira. Ele aparecerá na lista de carteiras e nas seleções.",
    "wallet.labels.name": "Nome da Carteira",
    "wallet.mnemonic.title": "Sua Frase Secreta",
    "wallet.mnemonic.description": "Anote essas palavras em um local seguro. Se você perder, não será possível recuperar a carteira.",
    "wallet.mnemonic.confirm.title": "Confirme sua Frase Secreta",
    "wallet.mnemonic.confirm.description": "Toque nas palavras na ordem correta para confirmar que você anotou sua frase de recuperação.",
    "wallet.mnemonic.placeholder": "Frase mnemônica, xpriv, xpub, zpriv ou zpub",
    "wallet.passphrase.title": "Adicione uma Passphrase a Carteira",
    "wallet.passphrase.description": "A passphrase torna sua carteira mais segura, se criada com a passphrase, a carteira só poderá ser importada com a passphrase correta.",
    "wallet.passphrase.continue": "Continuar sem Passphrase",
    "wallet.network.title": "Escolha a rede da carteira",
    "wallet.network.description": "Esta será a rede a qual a carteira irá interagir, enviar e receber transações.",
    "wallet.network.mainnet.title": "Carteira Mainnet",
    "wallet.network.mainnet.description": "A Mainnet é a rede oficial do Bitcoin, usada para transações reais.",
    "wallet.network.testnet.title": "Carteira Testnet",
    "wallet.network.testnet.description": "A Testnet é a rede de testes, onde as moedas não têm valor real — ideal para experimentar com segurança.",
    "wallet.import.title": "Importar Carteira",
    "wallet.import.description": "Cole ou digite sua frase mnemônica de 12 palavras ou sua chave estendida (xpriv/xpub/zpriv/zpub).",
    ...
    "wallet.transaction.block-hight": "Altura do Bloco",
    "wallet.transaction.confirmations": "Confirmações",
    "wallet.transaction.notconfirmed": "Não Confirmada",
