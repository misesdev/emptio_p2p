...
export default {
    ...
    "commons.seemore": "See more",
    "commons.seeless": "See less",
    ...
    "labels.relays.connecteds": "Connected relays",
    "labels.relays.disconnecteds": "Relays disconnected",
    ...
    "message.relay.invalid": "Invalid relay or offline!",
    "message.relay.invalid_format": "The relay is in an invalid format or offline!",
    ...
    "message.relay.adddetails": "Do you want to add the relay below to your relay list?",
    ...
    "wallet.create.label": "Create a new 12-word bip39 wallet with or without passphrase",
    "wallet.import.label": "Import a wallet from the 12-word bip39 with or without passphrase",
    "wallet.name.title": "Name your wallet",
    "wallet.name.description": "Choose a name to identify this wallet. It will appear in the wallet list and in selections.",
    "wallet.labels.name": "Wallet Name",
    "wallet.mnemonic.title": "Your Secret Phrase",
    "wallet.mnemonic.description": "Write these words down in a safe place. If you lose them, you won't be able to recover your wallet.",
    "wallet.mnemonic.confirm.title": "Confirm Your Secret Phrase",
    "wallet.mnemonic.confirm.description": "Tap the words in the correct order to confirm that you've written down your recovery phrase.",
    "wallet.mnemonic.placeholder": "Mnemonic phrase, xpriv, xpub, zpriv or zpub",
    "wallet.passphrase.title": "Add a Passphrase to Wallet",
    "wallet.passphrase.description": "The passphrase makes your wallet more secure, if created with the passphrase, the wallet can only be imported with the correct passphrase.",
    "wallet.passphrase.continue": "Continue without Passphrase",
    "wallet.network.title": "Choose wallet network",
    "wallet.network.description": "This will be the network on which the wallet will interact, send and receive transactions.",
    "wallet.network.mainnet.title": "Mainnet Wallet",
    "wallet.network.mainnet.description": "Mainnet is the official Bitcoin network, used for real-world transactions.",
    "wallet.network.testnet.title": "Testnet Wallet",
    "wallet.network.testnet.description": "Testnet is a test network where coins have no real value—ideal for safe experimentation.",
    "wallet.import.title": "Import Wallet",
    "wallet.import.description": "Paste or type your 12-word mnemonic phrase or your extended key (xpriv/xpub/zpriv/zpub).",
    ...
    "wallet.transfer.address": "Address",
    "wallet.transfer.wantfeepay": "Select the network fee to be paid",
    "wallet.fee.high.title": "High priority",
    "wallet.fee.high.description": "Recommended fee to confirm the transaction as quickly as possible, usually in the next block.",
    "wallet.fee.medium.title": "Medium priority",
    "wallet.fee.medium.description": "Recommended fee to confirm the transaction within 30 minutes (i.e. within approximately 3 blocks).",
    "wallet.fee.low.title": "Low priority",
